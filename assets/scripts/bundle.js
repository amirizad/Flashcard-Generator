...
// createCard(type, text, part);

function MyLibrary() {
  this.aSetting = true;
};

MyLibrary.prototype.createCard = function(type, text, part) {
    console.log(this.aSetting);
    if ( type === 'basic' ) {
        card = BasicCard(text,part);
    } else {
        try {
            card = ClozeCard(text,part);
        } catch (err) {
            return err;
...
// browserify backapp.js --standalone MyLibrary > bundle.js
},{"./BasicCard.js":1,"./ClozeCard.js":2,"underscore":4}],4:[function(require,module,exports){
//     Underscore.js 1.8.3
